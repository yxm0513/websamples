        ...
        4508: (e, t, s) => {
            ...
            class IconsManager {
                ...
                createSvgNode(e, t) {
                    ...
                    return Object.keys(s).map((e => n[e] = s[e])), Object.keys(o).map((e => n.setAttributeNS(null, e, o[e]))), n
                }
            ...
            e.exports = elementorModules.ViewModule.extend({
                ...
                showModal(e) {
                    ...
                    switch (n.setID(t.getSettings("modalOptions.id")), n.onShow = function() {
                        ...
                        DialogsManager.getWidgetType("lightbox").prototype.onHide.apply(n, arguments), n.getElements("message").removeClass("animated"), o.default.isFullscreen && t.deactivateFullscreen(), t.unbindHotKeys()
                    }, e.type) {
                        case "video":
                            t.setVideoContent(e);
                            break;
                ...
                setVideoContent(e) {
                    ...
                    if ("hosted" === e.videoType) {
                        ...
                        let o;
                        if (-1 !== e.url.indexOf("vimeo.com")) o = elementorFrontend.utils.vimeo;
                        else {
                    ...
                    const r = l.onHide;
                    l.onHide = function() {
                        r(), this.$buttons = jQuery(), this.focusedButton = null, l.getElements("message").removeClass("elementor-fit-aspect-ratio")
                    }
                },
                getShareLinks() {
                    const {
                    ...
                    }, s = jQuery, o = this.getSettings("classes"), i = this.getSettings("selectors"), l = s("<div>", {
                        class: o.slideshow.shareLinks
                    }), r = this.getSlide("active"), a = r.find(i.image), d = r.data("elementor-slideshow-video");
                    let c;
                    if (c = d || a.attr("src"), s.each(t, ((e, t) => {
                            const o = t.label,
                                n = s("<a>", {
                ...
                createShareLink(e, t) {
                    ...
                    const o = {};
                    return "pinterest" === e ? o.image = encodeURIComponent(t) : o.url = encodeURIComponent(location.href.replace(/#.*/, "") + s), ShareLink.getNetworkLink(e, o)
                },
                getSlideshowHeader() {
                    const {
                        i18n: e
                    } = elementorFrontend.config, t = jQuery, s = "yes" === elementorFrontend.getKitSettings("lightbox_enable_counter"), o = "yes" === elementorFrontend.getKitSettings("lightbox_enable_fullscreen"), i = "yes" === elementorFrontend.getKitSettings("lightbox_enable_zoom"), l = "yes" === elementorFrontend.getKitSettings("lightbox_enable_share"), r = this.getSettings("classes"), a = r.slideshow, d = this.elements;
                    if (s || o || i || l) {
                        if (d.$header = t("<header>", {
                            ...
                            o.on("click", (e => {
                                ...
                                class: a.shareMenu
                            }).append(o), d.$iconShare.add(d.$shareMenu).on("click", this.toggleShareMenu), d.$header.append(d.$iconShare, d.$shareMenu), this.$buttons = this.$buttons.add(d.$iconShare)
                        }
                        if (i) {
                            ...
                            this.isFontIconSvgExperiment || (l.class = a.iconZoomIn), d.$iconZoom = t(s).attr(l).on("click", this.toggleZoomMode), o.push(d.$iconZoom), this.isFontIconSvgExperiment && (d.$iconZoomOut = t(n.zoomOutBold.element).attr(i).addClass(r.hidden).on("click", this.toggleZoomMode), o.push(d.$iconZoomOut)), d.$header.append(o), this.$buttons = this.$buttons.add(o)
                        }
                        if (o) {
                            ...
                            this.isFontIconSvgExperiment || (l.class = a.iconExpand), d.$iconExpand = t(s).append(t("<span>"), t("<span>")).attr(l).on("click", this.toggleFullscreen), o.push(d.$iconExpand), this.isFontIconSvgExperiment && (d.$iconMinimize = t(n.frameMinimize.element).attr(i).addClass(r.hidden).on("click", this.toggleFullscreen), o.push(d.$iconMinimize)), d.$header.append(o), this.$buttons = this.$buttons.add(o)
                        }
                ...
                deactivateFullscreen() {
                    const e = this.getSettings("classes");
                    o.default.exit(), this.isFontIconSvgExperiment ? (this.elements.$iconExpand.removeClass(e.hidden).attr("aria-checked", "true"), this.elements.$iconMinimize.addClass(e.hidden).attr("aria-checked", "false")) : this.elements.$iconExpand.removeClass(e.slideshow.iconShrink).addClass(e.slideshow.iconExpand).attr("aria-checked", "false"), this.elements.$container.removeClass(e.slideshow.fullscreenMode)
                },
                activateZoom() {
                    const e = this.swiper,
                        t = this.elements,
                ...
                setSlideshowContent(e) {
                    const {
                        i18n: t
                    } = elementorFrontend.config, s = jQuery, o = 1 === e.slides.length, i = "" !== elementorFrontend.getKitSettings("lightbox_title_src"), l = "" !== elementorFrontend.getKitSettings("lightbox_description_src"), r = i || l, a = this.getSettings("classes"), d = a.slideshow, c = s("<div>", {
                        class: d.container
                    }), h = s("<div>", {
                    ...
                    if (e.slides.forEach((e => {
                            ...
                            if (e.video) {
                                ...
                                const l = s("<img>", n);
                                t.append([l, o]), i.append(t)
                            }
                            e.hash && i.attr("data-e-action-hash", e.hash), h.append(i)
                        })), this.elements.$container = c, this.elements.$header = this.getSlideshowHeader(), c.prepend(this.elements.$header).append(h), !o) {
                        ...
                        m = s("<div>", {
                            ...
                            "aria-label": t.next
                        }).html(o), c.append(p, m), this.$buttons = this.$buttons.add(p).add(m)
                    }
                ...
                activeKeyDown(e) {
                    ...
                    if (9 === e.which) {
                        ...
                        t.each((e => {
                            const i = t[e];
                            if (jQuery(i).is(":focus")) return s = i, o = 0 === e, n = t.length - 1 === e, !1
                        })), e.shiftKey ? o && (e.preventDefault(), t.last().trigger("focus")) : !n && s || (e.preventDefault(), t.first().trigger("focus"))
                    }
                },
                setVideoAspectRatio(e) {
                    ...
                    this.oldAspectRatio = e, s && t.removeClass(o.replace("%s", s)), e && t.addClass(o.replace("%s", e))
                },
                getSlide(e) {
                ...
                playSlideVideo() {
                    ...
                    let l, r;
                    o.append(n), e.append(o), -1 !== t.indexOf("vimeo.com") ? (l = "vimeo", r = elementorFrontend.utils.vimeo) : t.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) && (l = "youtube", r = elementorFrontend.utils.youtube);
                ...
                prepareYTVideo(e, t, s, o, n) {
                    ...
                    o.append(l), window.chrome && (r = e.PlayerState.UNSTARTED), s.addClass("elementor-loading " + i.invisible), this.player = new e.Player(l[0], {
                        videoId: t,
                        events: {
                            onReady: () => {
                                n.addClass(i.hidden), s.removeClass(i.invisible), this.player.playVideo()
                            },
                            onStateChange: e => {
                ...
                prepareVimeoVideo(e, t, s, o, n) {
                    ...
                    this.player = new e.Player(o, l), this.player.ready().then((() => {
                        n.addClass(i.hidden), s.removeClass(i.invisible)
                    }))
                },
                ...
                openSlideshow(e, t) {
                    ...
                    s.each((function() {
                        ...
                        void 0 === i && (i = s.index(this)), (t === this.href || e && t === e) && (n = i);
                        const l = {
                            image: this.href,
                            index: i,
                        ...
                        e && (l.video = e), o.push(l)
                    })), o.sort(((e, t) => e.index - t.index)), this.showModal({
                        type: "slideshow",
                        id: e,
                        modalOptions: {
                ...
                var t = "undefined" != typeof window && void 0 !== window.document ? window.document : {},
                    ...
                    o = function() {
                        for (var e, s = [
                            ...
                            ], o = 0, n = s.length, i = {}; o < n; o++)
                            if ((e = s[o]) && e[1] in t) {
                                var l = e.length;
                                for (o = 0; o < l; o++) i[s[0][o]] = e[o];
                                return i
                            }
                        return !1
                    }(),
                    ...
                    i = {
                        request(e) {
                            return new Promise(function(s, n) {
                                ...
                                this.on("change", i), e = e || t.documentElement, Promise.resolve(e[o.requestFullscreen]()).catch(n)
                            }.bind(this))
                        },
                        exit() {
                            return new Promise(function(e, s) {
                                if (this.isFullscreen) {
                                    ...
                                    this.on("change", n), Promise.resolve(t[o.exitFullscreen]()).catch(s)
                                } else e()
                            }.bind(this))
                        },
                        toggle(e) {
